...
import type { BallpitPhysicsConfig } from './types';

export class BallpitPhysics {
  ...
  #initializePositions() {
    ...
    for (let i = 1; i < config.count; i++) {
      ...
      velocityData[idx] = MathUtils.randFloatSpread(config.maxVelocity * 0.5);
      velocityData[idx + 1] = MathUtils.randFloatSpread(config.maxVelocity * 0.5);
      velocityData[idx + 2] = MathUtils.randFloatSpread(config.maxVelocity * 0.25);
    }
  }
